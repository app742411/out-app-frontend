...
export default function OccupancyStats() {
    ...
    const series = [68]; // Example current occupancy rate
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="grid grid-cols-2 gap-4 w-full mt-2">
                    <div className="text-center p-3 rounded-xl bg-green-50 dark:bg-green-500/5">
                        ...
                        <p className="text-xl font-bold text-gray-800 dark:text-white">124</p>
                    </div>
                    <div className="text-center p-3 rounded-xl bg-brand-50 dark:bg-brand-500/5">
                        ...
                        <p className="text-xl font-bold text-gray-800 dark:text-white">286</p>
                    </div>
                </div>
            </div>
        </div>
